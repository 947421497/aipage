...
class App
{
    ...
    private function initApp(string $app): void
    {
        ...
        if (!IS_CLI) {
            ...
            if (!empty($_SERVER['SCRIPT_NAME']) && !str_starts_with($_SERVER['SCRIPT_NAME'], '/')) {
                $_SERVER['SCRIPT_NAME'] = '/' . $_SERVER['SCRIPT_NAME'];
            }
            define('__WEB__', URL_REWRITE ? str_replace(['/index.php', 'index.php'], '', $_SERVER['SCRIPT_NAME']) : $_SERVER['SCRIPT_NAME']);
