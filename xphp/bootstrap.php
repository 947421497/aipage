...
const __VERSION__ = '6.1.1'; // 框架版本号
const __POWERED__ = 'XPHP_v' . __VERSION__; // 框架全称
...
require ROOT_PATH . '/xphp/function.php'; // 框架核心函数
require ROOT_PATH . '/xphp/helper.php'; // 助手函数
