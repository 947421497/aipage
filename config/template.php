...
return [
    ...
    'regex_replace' => [
        ...
        '/{\s*\$var\|default=(.+?)\s*}/i' => '<?php echo !empty($\\1) ? $\\1 : \\2?>', //$变量名|default=默认值
        '/{\s*\$var\.key\|default=(.+?)\s*}/i' => '<?php echo !empty($\\1[\'\\2\']) ? $\\1[\'\\2\'] : \\3?>', //$变量名.键名|default=默认值
        '/{\s*\$var\s*\?\?\s*(.+?)\s*}/i' => '<?php echo $\\1 ?? \\2?>', //$变量名 ?? 默认值
        '/{\s*\$var\.key\s*\?\?\s*(.+?)\s*}/i' => '<?php echo $\\1[\'\\2\'] ?? \\3?>', //$变量名.键名 ?? 默认值
        '/{\s*\$var\.key\.key\s*\?\?\s*(.+?)\s*}/i' => '<?php echo $\\1[\'\\2\'][\'\\3\'] ?? \\4?>', //$变量名.键名.键名 ?? 默认值
        '/{\s*\$var\|date=(.+?)\s*}/i' => '<?php echo date(\\2,$\\1)?>', //$变量名|date=日期格式
        '/{\s*\$var\|var=(.+?)\s*}/i' => '<?php echo \\2($\\1,\\3)?>', //$变量名|函数名=参数
        '/{\s*\$var\.key\|var\s*}/i' => '<?php echo \\3($\\1[\'\\2\'])?>', //$变量名.键名|函数
        '/{\s*\$var\.key\|date=(.+?)\s*}/i' => '<?php echo date(\\3,$\\1[\'\\2\'])?>', //$变量名.键名|date=日期格式
